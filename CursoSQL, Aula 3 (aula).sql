...
-- alterando a tabela estado, criando uma nova coluna
ALTER TABLE estado ADD COLUMN regiao INT;

-- alterando a tabela estado, modificando uma coluna
ALTER TABLE estado MODIFY COLUMN regiao VARCHAR(50) NOT NULL;

-- alterando a tabela estado, excluindo uma coluna
ALTER TABLE estado DROP COLUMN regiao;

--
ALTER TABLE estado ADD COLUMN regiao VARCHAR(50) NOT NULL DEFAULT "Não Informado" AFTER sigla;

-- melhorando a tabela estado
ALTER TABLE estado DROP CONSTRAINT valores_ativo_estado;
